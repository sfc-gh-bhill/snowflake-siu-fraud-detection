...
('NEMT', 'Nonemergency Medical Transportation', 'A0100', NULL, 'Non-emergency ambulance transport - base rate', NULL, NULL, NULL, 'Transport without corresponding clinical visit, excessive mileage, phantom rides', 'geospatial'),
('NEMT', 'Nonemergency Medical Transportation', 'A0080', NULL, 'Non-emergency ambulance transport - mileage', NULL, NULL, NULL, 'Mileage inconsistent with origin/destination, inflated distance claims', 'geospatial'),
('NEMT', 'Nonemergency Medical Transportation', 'T2003', NULL, 'Non-emergency transport - stretcher van', NULL, NULL, NULL, 'Stretcher transport without medical necessity documentation', 'geospatial'),
