...
SIU Nexus monitors 16 high-risk service categories across Medicaid and commercial plans,
...
with st.expander("Presenter Notes"):
    ...
    **Key Message:** The SIU team currently relies on manual claims review to detect fraud, waste,
    and abuse across high-risk Medicaid services. SIU Nexus demonstrates how Snowflake's
